...
<body>
    <div class="container-fluid text-white desenvolvedores">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center text-black mt-3" style="background: #121212;">
                ...
                <div class="col-md-6 col1">
                    <div class="card text-center" style="background: #121212;">
                        <div class="card-block" >
                            ...
                            <h4 class="card-title">Arthur Alves Reis</h4>
                            <small class="stack">Desenvolvedor Front-end</small>
                            <div class="midia-socialdev mt-3">
                                <ul>
                                    <li>
                ...
                <div class="col-md-6 col1">
                    <div class="card text-center" style="background: #121212;">
                        <div class="card-block">
                            ...
                            <h4 class="card-title">Tiago Alves dos Santos</h4>
