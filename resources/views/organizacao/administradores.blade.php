...
<body class="sb-nav-fixed">
    ...
    @component('componentes.modal', ['id' => 'adicionaradmin', 'titulo' => 'Adicionar Administrador'])
        <form class="needs-validation text-black" novalidate method="POST" action="{{ route('user.create') }}">
            @csrf
            <div class="form-column">
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        <label for="validationCustom01">Nome</label>
                        <input type="text" class="form-control" name="nome" id="nome-completo" placeholder="Nome Completo" required>
                        <div class="valid-feedback">Tudo certo!</div>
                        <div class="invalid-feedback">Id ?.</div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="nome-completo" placeholder="Telefone" name="telefone" required>
                        <div class="valid-feedback">Tudo certo!</div>
                        <div class="invalid-feedback">Id ?.</div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="password" class="form-control" id="idade" placeholder="Insira a senha" required name="senha">
                        <div class="valid-feedback">Tudo certo!</div>
                        <div class="invalid-feedback">Senha ?.</div>
                    </div>
                </div>
