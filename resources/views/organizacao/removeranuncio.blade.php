...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        ...
                        @include('includes.tabela_anuncios');
                    </div>
                </div>
            </main>
    ...
    @component('componentes.modal', ['id' => 'confirmarexclusao', 'titulo' => 'Confirmar Exclusão'])
        <form class="needs-validation text-black" novalidate method="POST" action="{{ route('evento.delete') }}">
            @csrf
            <div class="form-column">
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        <label for="validationCustom01">Coloque o id do anuncio para confirmar a exclusão!</label>
    ...
    @component('componentes.modal', ['id' => 'confirmarexclusaodetodos', 'titulo' => 'Confirmar exclusão de todos os anúncios'])
        <form class="needs-validation text-black" novalidate method="POST" action="{{ route('evento.format') }}">
            @csrf
            <div class="form-column">
                <div class="form-row">
                    <div class="col-md-12 mb-3">
